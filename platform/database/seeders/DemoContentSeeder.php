    ...
    public function run(): void
    {
        ...
        foreach ([
            'activities' => [
                'type' => 'activity',
                'label' => 'Activities',
                'url' => 'https://www.japan.travel/en/things-to-do/',
                'placement' => 'header',
                'notes' => 'Japan National Tourism Organization activity guide.',
                'sort_order' => 1,
            ],
            'hotels' => [
                'type' => 'hotel',
                'label' => 'Hotels',
                'url' => 'https://www.japan.travel/en/plan/accommodation/',
                'placement' => 'header',
                'notes' => 'Japan National Tourism Organization accommodation guide.',
                'sort_order' => 2,
            ],
            'flights' => [
                'type' => 'flight',
                ...
                'placement' => 'header',
                'notes' => 'Japan National Tourism Organization international arrival guide.',
                'sort_order' => 3,
            ],
            'rail-tickets' => [
                'type' => 'rail',
                ...
                'placement' => 'header',
                'notes' => 'Official Japan Rail Pass site.',
                'sort_order' => 4,
            ],
            'shop' => [
                'type' => 'shop',
                'label' => 'Shop',
                'url' => 'https://www.japan.travel/en/things-to-do/shopping/',
                'placement' => 'header',
                'notes' => 'Japan National Tourism Organization shopping guide.',
                'sort_order' => 5,
            ],
            'exchange-rate' => [
                'type' => 'exchange_rate',
                ...
                'placement' => 'header',
                'notes' => 'Common exchange-rate lookup for JPY planning.',
                'sort_order' => 6,
            ],
            'advertise' => [
                'type' => 'advertising',
                ...
                'placement' => 'footer',
                'notes' => 'Placeholder media inquiry address; replace before monetization.',
                'sort_order' => 7,
            ],
