...
class MediaPortalPublicTest extends TestCase
{
    ...
    public function test_homepage_renders_service_region_category_and_module_data(): void
    {
        ...
        $this->get('/')
            ...
            ->assertDontSee('https://example.com/rail', false)
            ->assertSee('Footer Planning Desk')
            ->assertDontSee('https://example.com/footer-planning', false)
            ->assertDontSee('rel="nofollow noopener sponsored"', false)
            ->assertSee('Kansai')
            ->assertSee('Food')
    ...
    public function test_homepage_module_items_render_public_targets_and_skip_disabled_or_unpublished_items(): void
    {
        ...
        $this->get('/')
            ...
            ->assertSee('href="'.PublicUrl::route('tools.index').'"', false)
            ->assertDontSee('href="https://example.com/module-rail"', false)
            ->assertDontSee('rel="nofollow noopener sponsored"', false)
